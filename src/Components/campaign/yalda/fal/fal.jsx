      ...
      <>
        <div className="fal-page">
          ...
          <div className="main-content">
            <div
              className={this.state.more ? "fal-wrapper more" : "fal-wrapper"}>
            ...
            <div className="fal-result">
              ...
              <p className="result-text">
                حافظ در این غزل روحی امیدوار را به نمایش می گذارد که به شیرینی
                زندگانی و بهبود روزگار آینده دلبسته است
              </p>
            </div>
            <div className="to-prize">
              <span className="arrow">{"<<"}</span>
              <Link to="./yalda">رفتن به جایزه</Link>
            </div>
          </div>
        </div>
        <FooterBot
