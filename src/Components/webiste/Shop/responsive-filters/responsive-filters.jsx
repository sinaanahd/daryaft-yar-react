        ...
        return (
            <div className="responsive-filters">
                <div className="labels">
                    <span
                        className="res-item"
                        onClick={()=>{this.handle_active_pop_up("o")}}
                    ...
                    <span
                        className="res-item"
                        onClick={()=>{this.handle_active_pop_up("f")}}
                        >
                        <img src={filterImg} alt="" />
                        فیلتر
                    </span>
                </div>
                <div className={this.state.active_pop_up ? "pop-stage active" : "pop-stage"}> 
                    {
                ...
                <div
                    onClick = {()=>{this.disable_pop_up()}}
                    className={this.state.active_pop_up ? "shadow active" : "shadow"}
                ></div>
            </div>
        );
    }
