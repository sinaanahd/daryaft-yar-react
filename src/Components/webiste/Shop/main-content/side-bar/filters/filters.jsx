...
class Filters extends Component {
  ...
  handle_filters = (clicked_id) => {
    ...
    let { publishers, subjects, grades, courses } = this.state;
      ...
      <>
        <div className="filters_wrapper">
          <div className="filter">
            <span className="text">پایه تحصیلی</span>
            <span
              className={this.state.open_g ? "arrow reverse" : "arrow"}
              onClick={() => {
                this.open_modals("g");
              }}>
              <img
            ...
            <ul className="sub-item">
              {this.state.grades.map((item) => (
                <li
                  ...
                  onClick={() => {
                    this.handle_clicked("grades", item.id);
                  }}
                  key={item.id}>
                  {item.name}
                </li>
          ...
          <div className="filter">
            <span className="text">رشته تحصیلی</span>
            <span
              className={this.state.open_s ? "arrow reverse" : "arrow"}
              onClick={() => {
                this.open_modals("s");
              }}>
              <img
            ...
            <ul className="sub-item">
              {this.state.subjects.map((item) => (
                <li
                  className={item.clicked ? "selected" : ""}
                  onClick={() => {
                    this.handle_clicked("subjects", item.id);
                  }}
                  key={item.id}>
                  {item.name}
                </li>
              ...
              {this.state.publishers ? (
                this.state.publishers.map((item) => (
                  <li
                    className={item.clicked ? "selected" : ""}
                    onClick={() => {
                      this.handle_clicked("publishers", item.id);
                    }}
                    key={item.id}>
                    {item.name}
                  </li>
          ...
          <div className="filter l">
            <span className="text">درس</span>
            <span
              className={this.state.open_c ? "arrow reverse" : "arrow"}
              onClick={() => {
                this.open_modals("c");
              }}>
              <img
            ...
            <ul className="sub-item">
              {this.state.courses.map((item) => (
                <li
                  className={item.clicked ? "selected" : ""}
                  onClick={() => {
                    this.handle_clicked("courses", item.id);
                  }}
                  key={item.id}>
                  {item.name}
                </li>
        ...
        <div className="filter-bts">
          ...
          <span
            onClick={() => {
              this.handle_filters(this.state.clicked_id);
            }}
